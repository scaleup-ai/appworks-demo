// Simple set of frontend handlers for the demo app.
// Exports small utilities the app can call consistently (open external URLs, copy text, download JSON, navigate).
...
export function openExternal(url: string, target: string = "_blank"): boolean {
  try {
    // If url is relative, make it absolute; otherwise use as-is
