...
const PaymentsPage: React.FC = () => {
  ...
  const handleReconcilePayment = (e: React.FormEvent) => {
    ...
    dispatch(reconcilePaymentStart({
      ...
      onError: (error) => showToast(`Failed to reconcile payment: ${error.message}`, { type: 'error' })
    }));
  };
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-gray-200">
                    ...
                    <th className="text-left py-3 px-4 font-medium text-gray-900">Matched Invoice</th>
        ...
        >
          <div className="space-y-4 text-sm text-gray-600">
            <div className="flex items-start gap-3">
              ...
              <div>
                <div className="font-medium text-gray-900">Enter Payment Details</div>
                <div>Provide the payment ID, amount, and optional reference information.</div>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <div className="font-medium text-gray-900">Automatic Matching</div>
                <div>The system attempts to match the payment to outstanding invoices using reference and amount.</div>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div>Matched payments are automatically applied. Unmatched payments require manual review.</div>
              </div>
            </div>
          </div>
        </Card>
